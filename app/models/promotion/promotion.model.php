...
NAME_FUNCTION::AJOUTER_PROMOTIONS->value => function (string $nom, string $dateDebut, string $dateFin, string $photo = null, string $status, array $refs, int $apprenants = 0): array {
    global $JsonService;
    $data = $JsonService[NAME_FUNCTION::JSON_TO_ARRAY->value]();
    ...
    $data["promotions"][] = [
        ...
        'date-fin' => $dateFin,
        'photo' => $photo ?? "/assets/images/dg.png",
        'status' => $status,
        'referentiels' => $refs,
        'apprenants' => $apprenants // Ajout du nombre d'apprenants
    ];
